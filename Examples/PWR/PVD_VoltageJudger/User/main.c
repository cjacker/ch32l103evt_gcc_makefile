...
/* Global Variable */
volatile uint8_t Voltage_3V_Flag=0;
...
void PVD_IRQHandler(void)
{
    if (EXTI_GetITStatus(EXTI_Line16) != RESET)
    {
        ...
        Voltage_3V_Flag = !PWR_GetFlagStatus(PWR_FLAG_PVDO);
        printf("Run at EXTI\r\n");
...
int main(void)
{
    ...
    {
        Delay_Ms(250);
        Voltage_3V_Flag?printf("Voltage is higher than 3.1V\r\n"):printf("Voltage is lower than 3.01V\r\n");
    }
}
